...
// isolated-vm ships prebuilds for darwin/win32/linux, but the image compiles the
// binding from source (node-gyp-build would otherwise prefer the glibc prebuild on
// this musl base). Dropping them here keeps 15MB out of the build context too.
